...
@Sql(scripts = "/sql/usuarios/vagas/vagas-insert.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(scripts = "/sql/usuarios/vagas/vagas-delete.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
public class VagaIT {
    ...
    @Test
    public void criarVaga_ComCodigoJaExistente_RetornaStatus409(){
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void criarVaga_ComDadosInvalidos_RetornaStatus422(){
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void buscarVaga_ComCodigoExistente_RetornaStatus200(){
        testClient
                .get()
    ...
    @Test
    public void buscarVaga_ComCodigoInexistente_RetornaStatus404(){
        testClient
                .get()
